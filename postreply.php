...
$_SESSION["postreply_tid"]="";
 $_SESSION["postreply_cid"]="";


$_SESSION["postreply_tid"]=$_SESSION["view_topic_tid"];
 $_SESSION["postreply_cid"]=$_SESSION["view_topic_cid"];
  ...
  <div class="row">
	...
	<div class="row">
		<div class="col-md-8">
			...
			<form action="postreplyparse.php" method="post">
			 <div class="form-group">
    <label for="body">Reply Content</label>
    <textarea class="form-control" id="body" name="reply_content" rows="10"></textarea>
...
<!--	<input type="hidden" name="cid" value="<?php echo $cid; ?>" />
	...
	<input type="submit" class="form-control btn btn-primary" value="Post Reply" name="reply_content_submit">
</div>

				</form>

			<?php
			/*$_SESSION["viewtopic_ccid"]=$_SESSION["viewtopic_cid"];
			$_SESSION["viewtopic_ttid"]=$_SESSION["viewtopic_tid"];*/
