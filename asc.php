...
<div class="container categor_block">
    ...
    //        echo $sorting_order;
            ...
            else if($sorting_order == "old"){
                $sort_view = "<br><br>
                        <form action='sort.php' method='post' style='color: black'>
                                Sort as: &nbsp;
                                <input type='radio' name='sort' value='old' checked> Oldest &ensp;<input type='radio' name='sort' value='new'> Newest
                                <input type='submit' name='sort_button' value='submit' style='color: black'>
                        </form>";
            }
            else{
                $sort_view = "
                        <form action='sort.php' method='post'style='color: white'>
                                Sort as: &nbsp;
			...
			if(mysqli_num_rows($res)==1){
				if($sorting_order == "new") $sql2="select *from topics where category_id='".$_SESSION["view_category_cateid"]."'  Order by topic_date desc";
                else if($sorting_order == "old"){
                    $sql2="select *from topics where category_id='".$_SESSION["view_category_cateid"]."'  Order by topic_date";
                }
                else{
				...
				<?php
					...
					if(mysqli_num_rows($res)>=1){
						...
						while($row = mysqli_fetch_assoc($res)){
						  ...
						  $poll .="<tr><td><div style='margin-top:100px; margin-left:00px;  width:280px; height:200px;'>
